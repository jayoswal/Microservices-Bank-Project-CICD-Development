package com.jayoswal.cards.controller;

import com.jayoswal.cards.constants.CardsConstants;
import com.jayoswal.cards.dto.CardsDto;
import com.jayoswal.cards.dto.DeveloperInfoDto;
import com.jayoswal.cards.dto.ErrorResponseDto;
import com.jayoswal.cards.dto.ResponseDto;
import com.jayoswal.cards.service.ICardsService;
...
@Tag(
        name = "CRUD REST APIs for Cards in Banl",
...
public class CardsController {
    ...
    public ResponseEntity<String> getPwd() {
        return ResponseEntity.ok(environment.getProperty("PWD"));
    }

    @GetMapping(value = "/developer-info")
    public ResponseEntity<DeveloperInfoDto> getDeveloperIndo() {
        return ResponseEntity
                .ok(developerInfoDto);
    }
